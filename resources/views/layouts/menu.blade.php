    ...
    <nav class="sidenav shadow-right sidenav-light">
        <div class="sidenav-menu">
            <div class="nav accordion" id="accordionSidenav">
                ...
                @hasanyrole('administrador|informante|proveedor')
                <!-- Sidenav Heading (Addons)-->
                <div class="sidenav-menu-heading">Incidentes</div>
                <a class="nav-link {{ (request()->routeIs('incidentes.index')) ? 'active' : '' }}" href="{{ route('incidentes.index')}}">
                    <div class="nav-link-icon"><i data-feather="clipboard"></i></div>
                    @lang('Incidentes')
                </a>
                @endhasanyrole
                @hasanyrole('administrador|seguridad')
                <!-- Sidenav Heading (Addons)-->
                ...
                @endhasanyrole
                @hasanyrole('administrador|produccion')
                <!-- Sidenav Heading (Addons)-->
                <div class="sidenav-menu-heading">Producción</div>
                ...
                <a class="nav-link {{ (request()->routeIs('sistemas.index')) ? 'active' : '' }}" href="{{ route('sistemas.index')}}">
                    <div class="nav-link-icon"><i data-feather="code"></i></div>
                    @lang('Sistemas')
                </a>
                
                <a class="nav-link {{ (request()->routeIs('referencias.index')) ? 'active' : '' }}" href="{{ route('referencias.index')}}">
                    <div class="nav-link-icon"><i data-feather="sliders"></i></div>
                    @lang('Referencias generales')
                </a>
                @endhasanyrole
                <!-- Sidenav Heading (Addons)-->
